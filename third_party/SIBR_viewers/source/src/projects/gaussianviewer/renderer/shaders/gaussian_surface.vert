...
void main() {
	boxID = gl_InstanceID * instance_stride;
	...
	ellipsoidScale = 2 * scale_modifier * ellipsoidScale;
	...
	float r = colors[boxID * 48 + 0] * 0.2820947918 + 0.5;
	float g = colors[boxID * 48 + 1] * 0.2820947918 + 0.5;
	float b = colors[boxID * 48 + 2] * 0.2820947918 + 0.5;
