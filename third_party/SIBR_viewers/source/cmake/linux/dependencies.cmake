...
option(SIBR_USE_EGL "Build GLEW for EGL/headless contexts" OFF)
find_package(EGL QUIET)

if(EGL_FOUND AND SIBR_USE_EGL)
...
## Find Boost
#############
# Boost.System and Boost.Chrono are header-only in recent Boost releases
# (including Ubuntu 26.04's 1.90 packages), so requesting legacy component
# libraries makes configuration fail even though the headers are available.
set(Boost_REQUIRED_COMPONENTS "filesystem;date_time" CACHE INTERNAL "Boost Required Components")
